...
# D15.4 Подключение к PostgreSQL
# DATABASES = {
#     'default': {
...
#настройки Celery/Redis  для Windows
# CELERY_BROKER_URL = 'redis://:B67cUbMjg2liAsxUPGfvfbYwMQQtwtdo@redis-14060.c280.us-central1-2.gce.cloud.redislabs.com:14060/0'
# CELERY_RESULT_BACKEND = 'redis://:B67cUbMjg2liAsxUPGfvfbYwMQQtwtdo@redis-14060.c280.us-central1-2.gce.cloud.redislabs.com:14060/0'
# CELERY_ACCEPT_CONTENT = ['application/json']
# CELERY_TASK_SERIALIZER = 'json'
# CELERY_RESULT_SERIALIZER = 'json'

# D11 п.51настройки кэширования
CACHES = {
    'default': {
